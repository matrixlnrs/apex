...
- **TIM6** : `PSC = 31`, `ARR = 999` → IRQ toutes les **1 ms** (⚠️ ne jamais mettre ARR = 0).
...
cd Debug
make -j4 all          # ⚠️ 'make all', pas 'make' seul
```
...
Projet réalisé dans le cadre du module Système à Microprocesseur — ISEN Toulon (2026).
